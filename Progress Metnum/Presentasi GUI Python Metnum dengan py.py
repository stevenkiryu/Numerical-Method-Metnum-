...
class App():
    ...
    def Integral_trapesium(self):
        ...
        while error_N_trape[len(error_N_trape) - 1] > error_trape:
            ...
            self.plot_error.plot(segmen_N_trape, error_N_trape , label = "Trapesium" , color = "green")
            self.plot_error.set_xlabel("Segmen N")
            self.plot_error.set_ylabel("Error Rate")
            
            self.plot_value.plot(segmen_N_trape, hasil_Int_trape , label = "Trapesium" , color = "green")
            self.plot_value.set_xlabel("Segmen N")
    ...
    def Integral_Simpson_sepertiga(self):
        ...
        while error_N_simpson_sepertiga[len(error_N_simpson_sepertiga) - 1] > error_simpson_sepertiga:
            ...
            if n % 2 != 0:
                ...
                self.plot_error.plot(segmen_N_simpson_sepertiga, error_N_simpson_sepertiga , label = "Simpson 1/3" , color = "blue")
                self.plot_error.set_xlabel("Segmen N")
                self.plot_error.set_ylabel("Error Rate")
                
                self.plot_value.plot(segmen_N_simpson_sepertiga, hasil_integrate_simpson_sepertiga , label = "Simpson 1/3" , color = "blue")
                self.plot_value.set_xlabel("Segmen N")
