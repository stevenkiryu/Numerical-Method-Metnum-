...
class App():
    ...
    def Integral_trapesium(self):
        ...
        # Dipanggil dari Entry menggunakan get dan conversi float karena method get merupakan string 
            ...
            messagebox.showinfo(title = "Calculate Error",message ="Maaf, mohon masukkan angka terlebih dahulu sebelum dihitung")
    ...
    def Integral_Simpson_sepertiga(self):
        # Maksudnya jika terjadi ValueError (Kosong input) maka akan memunculkkan keterangan calculate error
        try:
    ...
    def Calculate_Integral_Gabungan(self):
        try:
            ...
            messagebox.showinfo(title = "Calculate Error",message ="Maaf, masih ada angka yang kosong di salah satu metode")
